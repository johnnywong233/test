...
public class ServerTest {
    ...
    public void facetQueryCase() {
        ...
        try {
            ...
            //输出查询结果集
            SolrDocumentList list = response.getResults();
            print("Query result number: " + list.getNumFound());
//            list.forEach(this::print);
            ...
            print("Search facet [name] filed result: ");
            //输出分片信息
...
//            list.forEach(this::print);
    ...
    /**
     * <b>function:</b> test on other server method
     */
    @Test
    public void otherMethod() {
        print(server.getBinder());
        try {
            print(server.optimize());//合并索引文件，可以优化索引、提供性能，但需要一定的时间
            print(server.ping());//ping服务器是否连接成功
            ...
            print("rollback: " + server.rollback());
            //提交操作，提交后无法回滚之前操作；发现addBean没有成功添加索引
            print("commit: " + server.commit());
            queryAll();
    ...
    /**
     * <b>function:</b> add Entity Bean to index
     */
    @Test
    public void addBeans() {
        ...
        try {
            ...
            print(server.commit());//commit后才保存到索引库
            print(response);
        } catch (SolrServerException | IOException e) {
            e.printStackTrace();
        }
    ...
    /**
     * <b>function:</b> add JavaEntity Bean
     */
    @Test
    public void addBean() {
    ...
    public void addDoc() {
        ...
        try {
            ...
            print(server.commit());//commit后才保存到索引库
            print(response);
            print("query time：" + response.getQTime());
            print("Elapsed Time：" + response.getElapsedTime());
