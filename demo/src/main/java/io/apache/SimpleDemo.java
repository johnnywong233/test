...
/**
 * version 2.1: apache.commons.io contains ByteArrayOutputStream, but not ByteArrayInputStream, WTF
 * Created by johnny on 2016/10/6.
 * Simple usage of apache common io
 */
public class SimpleDemo {

    private static final String TXT_PATH =
            "D:\\Java_ex\\test\\src\\test\\resources\\1.txt";
    private static final String PARENT_DIR =
            "D:\\Java_ex\\test\\src\\test\\resources";
    ...
    private static final String XML_PATH =
            "D:\\Java_ex\\test\\src\\test\\resources\\test.xml";
    ...
    private void Utility() throws IOException {
        ...
        System.out.println("Base name of 1.txt: " + FilenameUtils.getBaseName(TXT_PATH));
        //create a new File object using FileUtils.getFile(String), and then use this object to get information from the file.
        ...
        iter.close();
        //check if a file exists somewhere inside a certain directory.
        ...
        //version 2.1 does not contain method directoryContains, 2.4 does
