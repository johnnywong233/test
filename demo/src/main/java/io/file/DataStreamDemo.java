...
public class DataStreamDemo {
    ...
    public static void main(String[] args){
        Member[] members = {new Member("Justin",90),
                ...
                new Member("Bush",88)};
        try{
            DataOutputStream dataOutputStream = new DataOutputStream(new FileOutputStream("C:\\work\\test\\src\\test\\resources\\test.txt"));
            ...
            DataInputStream dataInputStream = new DataInputStream(new FileInputStream("C:\\work\\test\\src\\test\\resources\\test.txt"));
