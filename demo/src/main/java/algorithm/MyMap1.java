...
public class MyMap1 {
    ...
    private final Map<String, List<String>> map = new HashMap<>();// 储存所有城市路线
    private final List<String> reachedWay = new ArrayList<>();// 储存到达目的地所经过的城市
    private final Map<Integer, String> routeMap = new HashMap<>();// 储存到达目的地所经过的城市和所用的时间，key为时间，value为reachedWay
